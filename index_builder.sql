...
create index FIRSTNAME_INDEX on PERSONS(first_name) indextype is ctxsys.context parameters('sync (on commit)');
create index LASTNAME_INDEX on PERSONS(last_name) indextype is ctxsys.context parameters('sync (on commit)');
